...
```bash
git remote add encore encore://ak4l-qshe-security-app-xodi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ak4l-qshe-security-app-xodi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ak4l-qshe-security-app-xodi/settings/integrations/github)
